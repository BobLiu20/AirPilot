                         ...
                         OS_OPT         opt)
{
    ...
    *(--p_stk)  = (CPU_STK)0x31uL;            /* S31                                                 */
    *(--p_stk)  = (CPU_STK)0x30uL;            /* S30                                                 */
    *(--p_stk)  = (CPU_STK)0x29uL;            /* S29                                                 */
    *(--p_stk)  = (CPU_STK)0x28uL;            /* S28                                                 */
    *(--p_stk)  = (CPU_STK)0x27uL;            /* S27                                                 */
    *(--p_stk)  = (CPU_STK)0x26uL;            /* S26                                                 */
    *(--p_stk)  = (CPU_STK)0x25uL;            /* S25                                                 */
    *(--p_stk)  = (CPU_STK)0x24uL;            /* S24                                                 */
    *(--p_stk)  = (CPU_STK)0x23uL;            /* S23                                                 */
    *(--p_stk)  = (CPU_STK)0x22uL;            /* S22                                                 */
    *(--p_stk)  = (CPU_STK)0x21uL;            /* S21                                                 */
    *(--p_stk)  = (CPU_STK)0x20uL;            /* S20                                                 */
    *(--p_stk)  = (CPU_STK)0x19uL;            /* S19                                                 */
    *(--p_stk)  = (CPU_STK)0x18uL;            /* S18                                                 */
    *(--p_stk)  = (CPU_STK)0x17uL;            /* S17                                                 */
    *(--p_stk)  = (CPU_STK)0x16uL;            /* S16 												  */
...
*********************************************************************************************************
*/
extern CPU_INT32U OutTickCount;
